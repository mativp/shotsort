import {
  BYTES_IN_A_DIRECTORY_HOLDING_ONE_ENTRY, BYTES_IN_TIFF_HEADER, EXIF_HEADER, PANASONIC_RAW_SIGNATURE,
  TIFF_STANDARD_SIGNATURE, TIFF_TAG_JPEG_FROM_RAW, TIFF_VALUE_TYPE_UNDEFINED, tiffDirectoryEntry,
  tiffDirectoryHolding, tiffFile, tiffHeaderPointingAtFirstDirectory,
} from './tiff.mjs';
