...
export function minoltaRawFile(dateTimeOriginal, { mark = '\0MRM', bytesInTheThumbnail = 24 } = {}) {
  ...
  const thumbnail = minoltaBlock('\0PRD', Buffer.alloc(bytesInTheThumbnail, 3));
  ...
  return Buffer.concat([minoltaBlock(mark, Buffer.alloc(0)).subarray(0, 4),
